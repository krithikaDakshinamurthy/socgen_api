...
3. Feature file has examples of reading request details from json and data tables.
4. This also has an example to validate response body using json path and assert.
